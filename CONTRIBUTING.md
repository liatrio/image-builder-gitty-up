...
_docs:_ You can start at the root [README.md](https://github.com/liatrio/image-builder-gitty-up/blob/main/README.md) to read more about the project and our goals.
...
Make sure you read our [Code of Conduct](https://github.com/liatrio/image-builder-gitty-up/blob/main/CODE_OF_CONDUCT.md), to make sure you know the standards we expect of the community.
